...
The 1-dimensional harmonic oscillator is a single particle being acted upon by a linear restoring force, $F(x) = - k x$. The Hamiltonian for the quantum harmonic oscillator is given by
\begin{equation}
